...
if __name__ == '__main__':
    ...
    query_feats = []
    query_path = '/root/halo/delg/data/nordland/delg_r50_gldv2/query'
    ...
    np.save('/root/halo/code/MSFFT/datasets/NordLand/delg_r50_feats/delg_qfeat', query_feats)

    query_feats = query_feats / LA.norm(query_feats, axis=-1)[:,None]

    index_feats = []
    db_path = '/root/halo/delg/data/nordland/delg_r50_gldv2/index'
    ...
    np.save('/root/halo/code/MSFFT/datasets/NordLand/delg_r50_feats/delg_dbfeat', index_feats)
    ...
    np.save('/root/halo/code/MSFFT/datasets/NordLand/delg_r50_feats/nordland_nn_inds', nn_inds)
