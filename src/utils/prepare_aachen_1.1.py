...
if __name__ == '__main__':
    ...
    with open('/root/halo/code/MSFFT/datasets/Aachen_v1.1/aachen_v1_1_query_c.txt') as fid:
        query_lines = fid.read().splitlines()
        query_lines = [q.split(',')[0] for q in query_lines]

    with open('/root/halo/code/MSFFT/datasets/Aachen_v1.1/aachen_v1_1_db_c.txt') as fid:
        gallery_lines = fid.read().splitlines()
        gallery_lines = [q.split(',')[0] for q in gallery_lines]

    query_feats = []
    query_path = '/root/halo/code/MSFFT/datasets/Aachen_v1.1/delg_feats/query'
    ...
    np.save('/root/halo/code/MSFFT/datasets/Aachen_v1.1/delg_feats/delg_qfeat', query_feats)

    query_feats = query_feats / LA.norm(query_feats, axis=-1)[:,None]

    index_feats = []
    db_path = '/root/halo/code/MSFFT/datasets/Aachen_v1.1/delg_feats/index'
    ...
    np.save('/root/halo/code/MSFFT/datasets/Aachen_v1.1/delg_feats/delg_dbfeat', index_feats)
    ...
    np.save('/root/halo/code/MSFFT/datasets/Aachen_v1.1/delg_feats/delg_Aachen_v1_1_rank_index', nn_inds)
